...
# ============================================================
st.set_page_config(
    page_title="Dashboard UMKM SLS — Cirebon",
    page_icon="🏗️",
    layout="wide",
...
# ============================================================
KODE_TERPILIH = "3209"
NAMA_TERPILIH = "Kabupaten Cirebon"
...
## KUALITAS
url_q = "https://simpul-jabar.32net.id/api/kualitas-data-rekap?kdkab=3209%20-%20KAB.%20CIREBON&kdkec=&kdkel=&level=sls"
...
with st.container(border=True):
       st.header("Progress Sensus Ekonomi 2026 Kabupaten Cirebon")
